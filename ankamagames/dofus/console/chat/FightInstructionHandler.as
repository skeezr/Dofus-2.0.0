package com.ankamagames.dofus.console.chat
{
   ...
   public class FightInstructionHandler implements ConsoleInstructionHandler
   {
      ...
      public function getHelp(cmd:String) : String
      {
         ...
         {
            case "spectator":
               return I18n.getText(I18nProxy.getKeyId("ui.chat.console.help.spectator"));
            case "list":
               return I18n.getText(I18nProxy.getKeyId("ui.chat.console.help.list"));
            case "players":
               return I18n.getText(I18nProxy.getKey("ui.chat.console.help.list"));
            case "kick":
               return I18n.getText(I18nProxy.getKeyId("ui.chat.console.help.kick"));
            default:
