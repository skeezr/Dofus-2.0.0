               ...
               for(j = 0; j < args.length; j++)
               {
                  ...
                  if(ApplicationDomain.currentDomain.hasDefinition(sClass))
                  {
                     ...
                     for each(accessor in xmlDef..accessor)
                     {
                        ...
                        for(i = 0; i < DONT_IGNORE.length; i++)
                        {
                        ...
                        if(Boolean(bDontIgnore) && (accessor..@type == "String" || accessor..@type == "Boolean" || accessor..@type == "Number" || accessor..@type == "uint" || accessor..@type == "int"))
                        {
                           try
                           {
