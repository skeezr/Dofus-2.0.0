package com.ankamagames.dofus.logic.game.common.frames
{
   ...
   public class PrismFrame implements Frame
   {
      ...
      private var _conquetesInformation:Vector.<PrismConquestInformation>;
      ...
      private var _attackers:Vector.<PrismFightersWrapper>;
      
      private var _defenders:Vector.<PrismFightersWrapper>;
      
      private var _reserves:Vector.<PrismFightersWrapper>;
      ...
      public function get attackers() : Vector.<PrismFightersWrapper>
      {
         return this._attackers;
      }
      
      public function get defenders() : Vector.<PrismFightersWrapper>
      {
         return this._defenders;
      }
      
      public function get reserves() : Vector.<PrismFightersWrapper>
      {
      ...
      public function _pickup_fighter(vec:Vector.<PrismFightersWrapper>, defenderId:uint) : PrismFightersWrapper
      {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         var defendersUpdated:Boolean = false;
         var reservesUpdated:Boolean = false;
         var pfdlmsg:PrismFightDefenderLeaveMessage = null;
         var pfdswmsg:* = undefined;
         ...
         switch(true)
         {
            ...
            case msg is PrismInfoJoinLeaveRequestAction:
               ...
               if(pijlract.join)
               {
                  this._attackers = new Vector.<PrismFightersWrapper>();
                  this._reserves = new Vector.<PrismFightersWrapper>();
                  this._defenders = new Vector.<PrismFightersWrapper>();
               }
            ...
            case msg is PrismBalanceResultMessage:
               ...
               KernelEventsManager.getInstance().processCallback(PrismHookList.PrismBalance);
               return true;
            ...
            case msg is PrismFightDefenderLeaveMessage:
               ...
               {
                  text = I18n.getText(I18nProxy.getKeyId("ui.prism.AutoDisjoin"));
            ...
            case msg is PrismFightAttackedMessage:
               ...
               subArea = SubArea.getSubAreaById(this.subareaId);
               info = I18n.getText(I18nProxy.getKeyId("ui.prism.attacked"),[subArea.name,"[" + this.worldX + "," + this.worldY + "]"]);
               KernelEventsManager.getInstance().processCallback(ChatHookList.TextInformation,info,ChatChannelsMultiEnum.CHANNEL_ALIGN);
      ...
      public function getSubAreasInformation(index:uint) : PrismSubAreaWrapper
      {
         ...
         return PrismSubAreaWrapper.create(prismInfo.subId,prismInfo.alignment,prismInfo.mapId,prismInfo.isInFight,prismInfo.isFightable,true);
      }
      
      public function getConquetesInformation(index:uint) : PrismConquestWrapper
      {
         var prismInfo:PrismConquestInformation = this._conquetesInformation[index];
         return PrismConquestWrapper.create(prismInfo.subId,prismInfo.alignment,prismInfo.isEntered,prismInfo.isInRoom);
      }
   }
}
