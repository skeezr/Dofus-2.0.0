package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayMerchantWithGuildInformations extends GameRolePlayMerchantInformations implements INetworkType
   {
      ...
      public function initGameRolePlayMerchantWithGuildInformations(contextualId:int = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, name:String = "", sellType:uint = 0, guildInformations:com.ankamagames.dofus.network.types.game.context.roleplay.GuildInformations = null) : GameRolePlayMerchantWithGuildInformations
      {
