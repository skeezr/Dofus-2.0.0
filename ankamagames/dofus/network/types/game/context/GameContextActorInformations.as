package com.ankamagames.dofus.network.types.game.context
{
   ...
   public class GameContextActorInformations implements INetworkType
   {
      ...
      public var disposition:com.ankamagames.dofus.network.types.game.context.EntityDispositionInformations;
      
      public function GameContextActorInformations()
      {
         this.look = new EntityLook();
         this.disposition = new com.ankamagames.dofus.network.types.game.context.EntityDispositionInformations();
         super();
      }
      ...
      public function initGameContextActorInformations(contextualId:int = 0, look:EntityLook = null, disposition:com.ankamagames.dofus.network.types.game.context.EntityDispositionInformations = null) : GameContextActorInformations
      {
      ...
      public function deserializeAs_GameContextActorInformations(input:IDataInput) : void
      {
         ...
         this.disposition = ProtocolTypeManager.getInstance(com.ankamagames.dofus.network.types.game.context.EntityDispositionInformations,_id3);
