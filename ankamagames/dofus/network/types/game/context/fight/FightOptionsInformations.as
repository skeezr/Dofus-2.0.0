package com.ankamagames.dofus.network.types.game.context.fight
{
   ...
   public class FightOptionsInformations implements INetworkType
   {
      ...
      {
         var _box0:uint = 0;
         BooleanByteWrapper.setFlag(_box0,0,this.isSecret);
         BooleanByteWrapper.setFlag(_box0,1,this.isRestrictedToPartyOnly);
         BooleanByteWrapper.setFlag(_box0,2,this.isClosed);
         BooleanByteWrapper.setFlag(_box0,3,this.isAskingForHelp);
