package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTemporaryBoostStateEffect extends FightTemporaryBoostEffect implements INetworkType
   {
      ...
      public function initFightTemporaryBoostStateEffect(uid:uint = 0, targetId:int = 0, turnDuration:int = 0, dispelable:uint = 1, spellId:uint = 0, delta:int = 0, stateId:int = 0) : FightTemporaryBoostStateEffect
      {
