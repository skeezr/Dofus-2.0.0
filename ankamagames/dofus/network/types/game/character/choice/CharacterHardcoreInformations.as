package com.ankamagames.dofus.network.types.game.character.choice
{
   ...
   public class CharacterHardcoreInformations extends CharacterBaseInformations implements INetworkType
   {
      ...
      public function initCharacterHardcoreInformations(id:uint = 0, name:String = "", level:uint = 0, entityLook:EntityLook = null, breed:int = 0, sex:Boolean = false, deathState:uint = 0, deathCount:uint = 0, deathMaxLevel:uint = 0) : CharacterHardcoreInformations
      {
