package com.ankamagames.dofus.network.types.game.mount
{
   ...
   public class MountClientData implements INetworkType
   {
      ...
      {
         var _box0:uint = 0;
         BooleanByteWrapper.setFlag(_box0,0,this.sex);
         BooleanByteWrapper.setFlag(_box0,1,this.isRideable);
         BooleanByteWrapper.setFlag(_box0,2,this.isWild);
         BooleanByteWrapper.setFlag(_box0,3,this.isFecondationReady);
         ...
         for(var _i32:uint = 0; _i32 < this.effectList.length; _i32++)
         {
      ...
      public function deserializeAs_MountClientData(input:IDataInput) : void
      {
         ...
         for(var _i32:uint = 0; _i32 < _effectListLen; _i32++)
         {
