package com.ankamagames.dofus.network.enums
{
   public class ExchangeErrorEnum
   {
      ...
      public static const BUY_ERROR:int = 7;
      
      public static const SELL_ERROR:int = 8;
      
      public static const MOUNT_PADDOCK_ERROR:int = 9;
      
      public static const BID_SEARCH_ERROR:int = 10;
