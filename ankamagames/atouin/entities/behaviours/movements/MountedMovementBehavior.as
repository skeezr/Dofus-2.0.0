package com.ankamagames.atouin.entities.behaviours.movements
{
   ...
   public class MountedMovementBehavior extends AnimatedMovementBehavior
   {
      ...
      private static var _self:com.ankamagames.atouin.entities.behaviours.movements.MountedMovementBehavior;
      ...
      public static function getInstance() : com.ankamagames.atouin.entities.behaviours.movements.MountedMovementBehavior
      {
         if(!_self)
         {
            _self = new com.ankamagames.atouin.entities.behaviours.movements.MountedMovementBehavior();
         }
         return _self;
      }
