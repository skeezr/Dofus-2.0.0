package com.ankamagames.atouin.entities.behaviours.movements
{
   ...
   public class ParableMovementBehavior extends AnimatedMovementBehavior
   {
      ...
      private static var _self:com.ankamagames.atouin.entities.behaviours.movements.ParableMovementBehavior;
      ...
      public static function getInstance() : com.ankamagames.atouin.entities.behaviours.movements.ParableMovementBehavior
      {
         if(!_self)
         {
            _self = new com.ankamagames.atouin.entities.behaviours.movements.ParableMovementBehavior();
         }
         return _self;
      }
