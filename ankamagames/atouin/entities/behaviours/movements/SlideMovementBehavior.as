package com.ankamagames.atouin.entities.behaviours.movements
{
   ...
   public class SlideMovementBehavior extends AnimatedMovementBehavior
   {
      ...
      private static var _self:com.ankamagames.atouin.entities.behaviours.movements.SlideMovementBehavior;
      ...
      public static function getInstance() : com.ankamagames.atouin.entities.behaviours.movements.SlideMovementBehavior
      {
         if(!_self)
         {
            _self = new com.ankamagames.atouin.entities.behaviours.movements.SlideMovementBehavior();
         }
         return _self;
      }
