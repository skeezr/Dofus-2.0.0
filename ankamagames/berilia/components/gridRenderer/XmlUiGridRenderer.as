package com.ankamagames.berilia.components.gridRenderer
{
   ...
   public class XmlUiGridRenderer implements IGridRenderer
   {
      ...
      public function render(data:*, index:uint, selected:Boolean, drawBackground:Boolean = true) : DisplayObject
      {
         ...
         this._uiCtr = new UiRootContainer(StageShareManager.stage,this._ctr);
      ...
      public function update(data:*, index:uint, dispObj:DisplayObject, selected:Boolean, drawBackground:Boolean = true) : void
      {
         ...
         {
            if(Boolean(UiRootContainer(dispObj).ready) && Boolean(Object(UiRootContainer(dispObj).uiClass)))
            {
            ...
            {
               this._dWaitingUpdate[dispObj] = new WaitingUpdate(data,index,dispObj,selected,drawBackground);
            }
         }
         else
         {
