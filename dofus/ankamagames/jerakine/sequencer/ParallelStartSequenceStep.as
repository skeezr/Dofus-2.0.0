package com.ankamagames.jerakine.sequencer
{
   ...
   public class ParallelStartSequenceStep extends AbstractSequencable
   {
      ...
      override public function start() : void
      {
         ...
         {
            if(Boolean(this._waitAllSequenceEnd) || Boolean(this._waitFirstEndSequence))
            {
      ...
      private function onSequenceEnd(e:SequencerEvent) : void
      {
         ...
         else if(this._sequenceEndCount == this._aSequence.length)
         {
