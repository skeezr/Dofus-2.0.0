package com.ankamagames.jerakine.resources.loaders.impl
{
   ...
   public class SingleRessourceLoader extends AbstractRessourceLoader implements IResourceLoader, IResourceObserver
   {
      ...
      public function load(uri:*, cache:ICache = null, forcedAdapter:Class = null) : void
      {
         if(this._uri != null)
         {
         ...
         if(!checkCache(this._uri))
         {
            ...
            this._protocol.load(this._uri,this,hasEventListener(ResourceProgressEvent.PROGRESS),_cache,forcedAdapter);
         }
      }
