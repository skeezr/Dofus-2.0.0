package com.ankamagames.jerakine.utils.misc
{
   ...
   public class CheckCompatibility
   {
      ...
      public static function isCompatible(reference:Class, target:*, strict:Boolean = false, throwError:Boolean = true) : Boolean
      {
         ...
         {
            if(Boolean(throwError) && !_cache[reference][cacheKey])
            {
         ...
         {
            if(!targetDesc..method.(@name == method.@name && (@returnType == method.@returnType || !strict && method.@returnType == "Object")).lenght)
            {
