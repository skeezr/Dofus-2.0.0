package com.ankamagames.dofus.logic.game.roleplay.frames
{
   ...
   public class RoleplayMovementFrame implements Frame
   {
      ...
      public function process(msg:Message) : Boolean
      {
         ...
         switch(true)
         {
            case msg is GameMapNoMovementMessage:
               ...
               {
                  this.activateSkill(this._followingIe.skillId,this._followingIe.ie);
                  this._followingIe = null;
               }
               return true;
      ...
      function askMoveTo(cell:MapPoint) : Boolean
      {
         ...
         Pathfinding.findPath(DataMapProvider.getInstance(),playerEntity.position,cell,!PlayedCharacterManager.getInstance().cantWalkInEightDirections,true,this.sendPath);
         return true;
      }
      ...
      function activateSkill(skillId:uint, ie:InteractiveElement) : void
      {
         var iurmsg:InteractiveUseRequestMessage = new InteractiveUseRequestMessage();
         iurmsg.initInteractiveUseRequestMessage(ie.elementId,skillId);
