package com.ankamagames.dofus.network.types.game.actions.fight
{
   ...
   public class FightTemporaryBoostWeaponDamagesEffect extends FightTemporaryBoostEffect implements INetworkType
   {
      ...
      public function initFightTemporaryBoostWeaponDamagesEffect(uid:uint = 0, targetId:int = 0, turnDuration:int = 0, dispelable:uint = 1, spellId:uint = 0, delta:int = 0, weaponTypeId:int = 0) : FightTemporaryBoostWeaponDamagesEffect
      {
         super.initFightTemporaryBoostEffect(uid,targetId,turnDuration,dispelable,spellId,delta);
