package com.ankamagames.dofus.network.types.game.character.choice
{
   ...
   public class CharacterBaseInformations extends CharacterMinimalPlusLookInformations implements INetworkType
   {
      ...
      public function initCharacterBaseInformations(id:uint = 0, name:String = "", level:uint = 0, entityLook:EntityLook = null, breed:int = 0, sex:Boolean = false) : CharacterBaseInformations
      {
