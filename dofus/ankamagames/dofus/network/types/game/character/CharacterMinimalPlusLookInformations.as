package com.ankamagames.dofus.network.types.game.character
{
   ...
   public class CharacterMinimalPlusLookInformations extends CharacterMinimalInformations implements INetworkType
   {
      ...
      public function initCharacterMinimalPlusLookInformations(id:uint = 0, name:String = "", level:uint = 0, entityLook:EntityLook = null) : CharacterMinimalPlusLookInformations
      {
