package com.ankamagames.dofus.network.types.game.context.roleplay
{
   ...
   public class GameRolePlayCharacterInformations extends GameRolePlayHumanoidInformations implements INetworkType
   {
      ...
      public function initGameRolePlayCharacterInformations(contextualId:int = 0, look:EntityLook = null, disposition:EntityDispositionInformations = null, name:String = "", humanoidInfo:HumanInformations = null, alignmentInfos:ActorAlignmentInformations = null) : GameRolePlayCharacterInformations
      {
