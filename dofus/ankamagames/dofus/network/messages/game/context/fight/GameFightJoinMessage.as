package com.ankamagames.dofus.network.messages.game.context.fight
{
   ...
   public class GameFightJoinMessage extends NetworkMessage implements INetworkMessage
   {
      ...
      {
         var _box0:uint = 0;
         BooleanByteWrapper.setFlag(_box0,0,this.canBeCancelled);
         BooleanByteWrapper.setFlag(_box0,1,this.canSayReady);
         BooleanByteWrapper.setFlag(_box0,2,this.isSpectator);
         BooleanByteWrapper.setFlag(_box0,3,this.isFightStarted);
