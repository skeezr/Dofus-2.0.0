package com.ankamagames.dofus.network.messages.game.actions.fight
{
   ...
   public class GameActionFightSpellCastMessage extends AbstractGameActionFightTargetedAbilityMessage implements INetworkMessage
   {
      ...
      public function initGameActionFightSpellCastMessage(actionId:uint = 0, sourceId:int = 0, destinationCellId:int = 0, critical:uint = 1, silentCast:Boolean = false, spellId:uint = 0, spellLevel:uint = 0) : GameActionFightSpellCastMessage
      {
         super.initAbstractGameActionFightTargetedAbilityMessage(actionId,sourceId,destinationCellId,critical,silentCast);
