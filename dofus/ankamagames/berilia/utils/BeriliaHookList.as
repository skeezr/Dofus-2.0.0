package com.ankamagames.berilia.utils
{
   ...
   public class BeriliaHookList
   {
      ...
      public static const UiLoaded:Hook = new Hook("UiLoaded",true);
      
      public static const ChatHyperlink:Hook = new Hook("ChatHyperlink",true);
      
      public static const UiUnloading:Hook = new Hook("UiUnloading",true);
      
      public static const UiUnloaded:Hook = new Hook("UiUnloaded",true);
