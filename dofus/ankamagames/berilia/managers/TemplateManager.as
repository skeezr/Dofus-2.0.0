package com.ankamagames.berilia.managers
{
   ...
   public class TemplateManager extends EventDispatcher
   {
      ...
      protected static const _log:Logger = Log.getLogger(getQualifiedClassName(com.ankamagames.berilia.managers.TemplateManager));
      
      private static var _self:com.ankamagames.berilia.managers.TemplateManager;
      ...
      public static function getInstance() : com.ankamagames.berilia.managers.TemplateManager
      {
         if(_self == null)
         {
            _self = new com.ankamagames.berilia.managers.TemplateManager();
         }
         return _self;
      }
      ...
      {
         _log.debug("objectLoadedFailed : " + e.uri);
      }
   }
}
